...
// CONCATENATED MODULE: ./src/components/Progress.jsx
...
// CONCATENATED MODULE: ./src/components/CheckSuccess.jsx
function CheckSuccess_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CheckSuccess_typeof = function _typeof(obj) { return typeof obj; }; } else { CheckSuccess_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CheckSuccess_typeof(obj); }

function CheckSuccess_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CheckSuccess_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function CheckSuccess_createClass(Constructor, protoProps, staticProps) { if (protoProps) CheckSuccess_defineProperties(Constructor.prototype, protoProps); if (staticProps) CheckSuccess_defineProperties(Constructor, staticProps); return Constructor; }

function CheckSuccess_possibleConstructorReturn(self, call) { if (call && (CheckSuccess_typeof(call) === "object" || typeof call === "function")) { return call; } return CheckSuccess_assertThisInitialized(self); }

function CheckSuccess_getPrototypeOf(o) { CheckSuccess_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return CheckSuccess_getPrototypeOf(o); }

function CheckSuccess_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function CheckSuccess_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CheckSuccess_setPrototypeOf(subClass, superClass); }

function CheckSuccess_setPrototypeOf(o, p) { CheckSuccess_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CheckSuccess_setPrototypeOf(o, p); }

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



var CheckSuccess_Check =
/*#__PURE__*/
function (_Component) {
  CheckSuccess_inherits(Check, _Component);

  function Check(props) {
    var _this;

    CheckSuccess_classCallCheck(this, Check);

    _this = CheckSuccess_possibleConstructorReturn(this, CheckSuccess_getPrototypeOf(Check).call(this, props));

    _defineProperty(CheckSuccess_assertThisInitialized(_this), "reportFail", function (e) {
      e.preventDefault();

      _this.props.report(1);
    });

    _defineProperty(CheckSuccess_assertThisInitialized(_this), "reportSuccess", function (e) {
      e.preventDefault();

      _this.props.report(0);
    });

    _defineProperty(CheckSuccess_assertThisInitialized(_this), "reportUnknown", function (e) {
      e.preventDefault();
...
// CONCATENATED MODULE: ./src/components/Record.jsx
function Record_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Record_typeof = function _typeof(obj) { return typeof obj; }; } else { Record_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Record_typeof(obj); }
...
function Record_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Record_createClass(Constructor, protoProps, staticProps) { if (protoProps) Record_defineProperties(Constructor.prototype, protoProps); if (staticProps) Record_defineProperties(Constructor, staticProps); return Constructor; }

function Record_possibleConstructorReturn(self, call) { if (call && (Record_typeof(call) === "object" || typeof call === "function")) { return call; } return Record_assertThisInitialized(self); }

function Record_getPrototypeOf(o) { Record_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Record_getPrototypeOf(o); }

function Record_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Record_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Record_setPrototypeOf(subClass, superClass); }

function Record_setPrototypeOf(o, p) { Record_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Record_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_Component) {
  Record_inherits(Record, _Component);
  ...
  function Record(props) {
    ...
    _this = Record_possibleConstructorReturn(this, Record_getPrototypeOf(Record).call(this, props));

    Record_defineProperty(Record_assertThisInitialized(_this), "updateCount", function (e) {
      e.preventDefault();
  ...
  Record_createClass(Record, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", null, react_default.a.createElement("label", {
        htmlFor: "count"
      }, "Count: "), react_default.a.createElement("input", {
        type: "number",
        name: "count",
...
// CONCATENATED MODULE: ./src/components/IDBTest.jsx
function IDBTest_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { IDBTest_typeof = function _typeof(obj) { return typeof obj; }; } else { IDBTest_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return IDBTest_typeof(obj); }

function IDBTest_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function IDBTest_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function IDBTest_createClass(Constructor, protoProps, staticProps) { if (protoProps) IDBTest_defineProperties(Constructor.prototype, protoProps); if (staticProps) IDBTest_defineProperties(Constructor, staticProps); return Constructor; }

function IDBTest_possibleConstructorReturn(self, call) { if (call && (IDBTest_typeof(call) === "object" || typeof call === "function")) { return call; } return IDBTest_assertThisInitialized(self); }

function IDBTest_getPrototypeOf(o) { IDBTest_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return IDBTest_getPrototypeOf(o); }

function IDBTest_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function IDBTest_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) IDBTest_setPrototypeOf(subClass, superClass); }

function IDBTest_setPrototypeOf(o, p) { IDBTest_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return IDBTest_setPrototypeOf(o, p); }

function IDBTest_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/*#__PURE__*/
function (_Component) {
  IDBTest_inherits(Test, _Component);

  function Test(props) {
    var _this;

    IDBTest_classCallCheck(this, Test);

    _this = IDBTest_possibleConstructorReturn(this, IDBTest_getPrototypeOf(Test).call(this, props));

    IDBTest_defineProperty(IDBTest_assertThisInitialized(_this), "sendCommand", function (e) {
      if (e.target.id === 'set') {
        navigator.serviceWorker.controller.postMessage('set');
      } else {
        var p = new Promise(function (resolve, reject) {
          // Create a Message Channel
          var msg_chan = new MessageChannel(); // Handler for recieving message reply from service worker
          ...
          navigator.serviceWorker.controller.postMessage('get');
        });
      }
    });
    ...
    _this.port = chan.port1;
    navigator.serviceWorker.controller.postMessage('setup', [chan.port2]);
    return _this;
  }

  IDBTest_createClass(Test, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("button", {
        onClick: this.setup
      }, " Create Message Channel"), react_default.a.createElement("button", {
        onClick: this.sendCommand,
        id: 'set'
      }, " Store Data"), react_default.a.createElement("button", {
        onClick: this.sendCommand,
        id: 'get'
      }, " Get Data "), react_default.a.createElement("div", null, "Received Data: ", this.state.data, " "));
    }
  }]);
...
// CONCATENATED MODULE: ./src/components/DebugTools.jsx
function DebugTools_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { DebugTools_typeof = function _typeof(obj) { return typeof obj; }; } else { DebugTools_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return DebugTools_typeof(obj); }

function DebugTools_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DebugTools_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DebugTools_createClass(Constructor, protoProps, staticProps) { if (protoProps) DebugTools_defineProperties(Constructor.prototype, protoProps); if (staticProps) DebugTools_defineProperties(Constructor, staticProps); return Constructor; }

function DebugTools_possibleConstructorReturn(self, call) { if (call && (DebugTools_typeof(call) === "object" || typeof call === "function")) { return call; } return DebugTools_assertThisInitialized(self); }

function DebugTools_getPrototypeOf(o) { DebugTools_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return DebugTools_getPrototypeOf(o); }

function DebugTools_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function DebugTools_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) DebugTools_setPrototypeOf(subClass, superClass); }

function DebugTools_setPrototypeOf(o, p) { DebugTools_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return DebugTools_setPrototypeOf(o, p); }

function DebugTools_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }




var DebugTools_Tools =
/*#__PURE__*/
function (_Component) {
  DebugTools_inherits(Tools, _Component);

  function Tools(props) {
    var _this;

    DebugTools_classCallCheck(this, Tools);

    _this = DebugTools_possibleConstructorReturn(this, DebugTools_getPrototypeOf(Tools).call(this, props));

    DebugTools_defineProperty(DebugTools_assertThisInitialized(_this), "clear", function () {
      var action = {
        source: constants["a" /* default */].APP_ID,
        type: constants["a" /* default */].CLEAR
      };
      navigator.serviceWorker.controller.postMessage(action);
    });

    DebugTools_defineProperty(DebugTools_assertThisInitialized(_this), "setup", function () {
      _this.props.setup();
    });
  ...
  DebugTools_createClass(Tools, [{
    key: "render",
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("button", {
        onClick: this.clear
      }, "Clear DB"), react_default.a.createElement("button", {
        onClick: this.setup
      }, "Re-run Setup"));
    }
  }]);
...
// CONCATENATED MODULE: ./src/components/display.jsx
...
function display_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/*#__PURE__*/
function (_Component) {
  display_inherits(Display, _Component);
  ...
  function Display() {
    ...
    _this = display_possibleConstructorReturn(this, display_getPrototypeOf(Display).call(this));

    display_defineProperty(display_assertThisInitialized(_this), "setup", function () {
      var chan = new MessageChannel();
    ...
    display_defineProperty(display_assertThisInitialized(_this), "updateState", function (e) {
      console.log("I received the state from the sw!");
      console.log(e);

      _this.setState(e.data);
    });

    display_defineProperty(display_assertThisInitialized(_this), "increment", function (delta) {
      console.log("received increment action");
      var action = {
        source: constants["a" /* default */].APP_ID,
    ...
    display_defineProperty(display_assertThisInitialized(_this), "report", function (status) {
      console.log("received report action");
      var action = {
        source: constants["a" /* default */].APP_ID,
  ...
  display_createClass(Display, [{
    ...
    value: function render() {
      return react_default.a.createElement(react_default.a.Fragment, null, debug && react_default.a.createElement(DebugTools_Tools, {
        setup: this.setup
      }), react_default.a.createElement(Progress_Progress, {
        current: this.state.current,
        goal: this.state.goal
      }), react_default.a.createElement(CheckSuccess_Check, {
        report: this.report
      }), react_default.a.createElement(Record_Record, {
        update: this.increment
      }));
    }
  }]);
